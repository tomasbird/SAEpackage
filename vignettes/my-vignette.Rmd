...
![Load button for survey data](images/Load_Survey.png){#id .class width=30% height=30%}
<br/>
...
![The Census tab controls upload and structuring of census data](images/Census_Tab.png){#id .class width=50% height=50%}
...
![Removal of 'mother tongue' as a predictor](images/Tab4_Exclude_Parameters.png){#id .class width=30% height=30%}
...
![Stepwise selection button](images/Tab4_Stepwise_Button.png){#id .class width=30% height=30%}
...
![Plot of model residuals](images/Tab5_Residplot.png){#id .class width=50% height=50%}
<br/>
...
![Observed verus predicted outcomes aggregated at survey region level](images/Tab5_Obs_vs_pred.png){#id .class width=50% height=50%}
...
![A confusion matrix showing the rate of true positives and negatives](images/Tab5_Confusion.png){#id .class width=50% height=50%}
<br/>
...
![The Receiver-Operator Curve](images/Tab5_ROC.png){#id .class width=50% height=50%}
<br/>
...
![Results of the cross validation.  Similar AUC scores in the training and test data indicate the model is relatively stable.](images/Tab5_Cross_Validate.png){#id .class width=50% height=50%}
<br/>
...
![Tabular results](images/Tab6_Prediction.png)
